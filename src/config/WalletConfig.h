...
// Copyright (c) 2019, The USDX Developers
// 
...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "UsdX";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "USDX";
    ...
    const std::string daemonName = "usdxCoind";
    ...
    const std::string contactLink = "http://www.usdx.co";
